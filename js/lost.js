$(document).ready(function(){
    $("#submit").click(function(){
        ...
        else
        {
            ...
            if(src == "Hadayek El Ahram" &&  dest == "Cairo Staduim"){
                $("#road").html(`
                    <li>
                ...
                else if(src == "Dokki" &&  dest == "Great Cairo Library"){
                    $("#road").html(`
                        <li>
                ...
                else if(src == "Abaseya" &&  dest == "Zamalek"){
                    $("#road").html(`
                        <li>
                ...
                {
                    $("#warning").html("Out of our data, please try another source or destination");
                    $("#warning").css("display",  "block");
                }
        }
